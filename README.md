...
- Converging path of the economic words: dynamics of the Euclidean distances from the matrices of word vectors of period $t$ to that of period $t-1$ and that of the final period in each time slices.

![converging_path](doc/converging_path_economic_words.png)

- Movement path of the political and economic words.

![movement_path](doc/movement_path.png)
